                                        ...
                                        <div className="  ">
                                            ...
                                            <div className=" md:flex justify-between w-full ">
                                                ...
                                                <div className="p-3 md:flex gap-3  ms-auto space-y-3 md:space-y-0  ">
                                                    ...
                                                    <Link to="/admin/customers/viewcustomers/customersaddress" className="px-3  flex justify-around md:w-fit  w-full gap-2 ms-auto items-center py-1.5  font-larze text-white bg-success  focus:ring-4 focus:outline-none  rounded-md ">
