...
const AddStates = () => {
    ...
    const [state, setState] = useState({
       ...
       const {countryName, status, stateName} = state
       ...
       async function viewState() {
           let result = await axios.get(`http://localhost:4000/api/viewState/${id}`)
           setState(result.data[0]) 
       }
   
       async function handleSubmit(e){
           e.preventDefault()
           await axios.put(`http://localhost:4000/api/updateState/${id}`, state) 
                ...
                <div className="  text-neutral-600 mx-auto text-md antialiased font-normal  p-5   ">
                    ...
                    <div className=" p-2 relative top-5 my-5 mt-5 antialiased">
                        <div className="text-xl md:py-5 py-3">Dashboard /  <span className='text-gray font-semibold'>Settings /</span>
                            ...
                            <span className='text-gray font-semibold'>States</span>
                        </div>
                    </div>
