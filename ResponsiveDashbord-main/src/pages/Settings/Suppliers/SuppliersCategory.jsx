        ...
        <section>
            <div className="  text-neutral-600 mx-auto text-md antialiased font-normal  p-5   ">
                ...
                <div className=" p-2 relative top-5 my-5 mt-5 antialiased">
                    <div className="text-xl md:py-5 py-3">Dashboard /  <span className='text-gray font-semibold'>Suppliers /</span>
                        <span className='text-gray font-semibold'>Address Category</span>
                    </div>
                </div>
...
export default SuppliersCategory
