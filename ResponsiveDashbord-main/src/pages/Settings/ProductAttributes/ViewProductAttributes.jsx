                        ...
                        <div className=" mt-[2rem]  md:mt-0  shadow-md md:p-2 bg-white rounded-md antialiased ">
                            ...
                            <div className="  ">
                                ...
                                <div className=" md:flex justify-between  ">
                                    ...
                                    <div className="p-3 text-xl font-semibold">Product Attributes- <span className='text-red-500'>(Size)</span></div>
                                                ...
                                                {currentData.map((row) => (
                                                    <tr key={row.id} className=" border-b dark:bg-gray-800 dark:border-gray-700">
                                                        ...
                                                        <td class="px-6 py-4 flex gap-2 justify-center">
                                                            <Link to="/admin/settings/editProductAttributeOptions"><FaRegEdit className='text-green-400 pointer' size={20} /></Link>
