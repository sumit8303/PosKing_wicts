                ...
                <div className="  text-neutral-600 mx-auto text-md antialiased font-normal  p-5   ">
                    ...
                    <div className=" p-2 relative top-5 my-5 mt-5 antialiased">
                        <div className="text-xl md:py-5 py-3">Dashboard /
                            <span className='text-gray font-semibold'> Purchases /</span>
...
<div className="grid md:grid-cols-2 grid-cols-1 gap-5 p-3 mx-auto">

                            <div className="p-4 text-center md:text-justify w-full grid grid-cols-1 border border-gray rounded-md mx-auto">
  <div className="py-2 mx-auto md:mx-0 text-blue-500 "><AiFillProduct /> </div>
  <div className="text-darkgray font-semibold "><span>Supplier:</span>1003</div>
  <div className="text-gray font-semibold "><span>Location:</span>Dhaka Bangladesh, Dhaka</div>
  <div className="text-gray font-semibold "><span>Phone:</span>12548797653</div>
  <div className="text-gray font-semibold "><span>Email:</span>smith@example.com</div>
                            </div>
                            <div className="p-4 text-center md:text-justify w-full gap-0 grid grid-cols-1 border border-gray rounded-md mx-auto">
  ...
  <div className="text-darkgray font-semibold "><span>Status:</span><span className='text-red-500'>Received</span></div>
                            </div>
