...
const EditCustAddress = () => {
    ...
    const {name, email, phoneNumber, country, state, city, zipCode, streetAddress} = customerAddress
    ...
    async function viewEmployeeAddress() {
        let result = await axios.get(`http://localhost:4000/api/viewCustomerEmployee/${id}`)
        setCustomerAddress(result.data[0]) 
    }
    ...
    async function handleSubmit(e) {
        e.preventDefault()
        await axios.put(`http://localhost:4000/api/updateCustomerAddress/${id}`, customerAddress)
        ...
        <section>
            <div className="  text-neutral-600 mx-auto text-md antialiased font-normal  p-5   ">
                ...
                <div className=" p-2 relative top-5 my-5 mt-5 antialiased">
                    <div className="text-xl md:py-5 py-3">Dashd /  <span className='text-gray font-semibold'>Customers /</span>
...
export default EditCustAddress
