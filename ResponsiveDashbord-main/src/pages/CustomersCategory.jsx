                        ...
                        <div className="flex items-center justify-between  p-1  ">
                            ...
                            <div className="md:flex  w-full justify-between ">
                                ...
                                <div className="md:flex md:space-y-0 space-y-2 mx-auto md:mx-0  gap-4 ">
                                    ...
                                    <Link to="/admin/customers/viewcustomers" className="px-3 flex justify-around bg-gray text-white rounded-full gap-2 items-center md:py-1.5 py-1 font-larze hover:bg-black focus:ring-4 focus:outline-none  rounded-md ">
